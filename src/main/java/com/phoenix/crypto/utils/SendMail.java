    ...
    public static void sendMail(double price) {
        ...
        Session session = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    ...
                    {
                        return new PasswordAuthentication("lord.aiwass777@gmail.com", "Aiwass777");
                    }
                });
        ...
        try {
            ...
            message.setFrom(new InternetAddress("lord.aiwass777@gmail.com"));

            Address[] toUser = InternetAddress
                    .parse("lord.aiwass777@gmail.com");
